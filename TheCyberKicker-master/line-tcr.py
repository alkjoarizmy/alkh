...
#-----------------------------------------------
            ...
            elif msg.text in ["Masuk","Jarvis","bot"]:
				if msg.from_ in admin:
...
#-----------------------------------------------
					...
					ki.sendText(msg.to,"hmmmmmmmmmmmmmmmmmmmmmm................")
            elif msg.text in [":v"]:
					ki.sendText(msg.to,":V")
            elif msg.text in ["wkwkwk"]:
					ki.sendText(msg.to,"apa yang lucu?")
					...
					ki.sendText(msg.to,"Welcome!")
					kk.sendText(msg.to,"Jangan nakal ok!")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Samlekom","samlekom","assalamualaikum"]:
				ki.sendText(msg.to,"Waalaikumsalam􏿿")
				kk.sendText(msg.to,"􏿿")
				kc.sendText(msg.to,"")
#-----------------------------------------------
...
#------------------------------------------------------------------
    ...
    #-------------Fungsi Tagall User Finish By :ᴋᴀʀɪᴀ -------------#
               ...
               if msg.from_ in admin:
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"OI !")
                       kk.sendText(g.mid,"OI !")  
                       ki.sendText(g.mid,"OI !")  
                       kc.sendText(g.mid,"OI !")
                       kk.sendText(g.mid,"OI !")  
                       ki.sendText(g.mid,"OI !")  
                       kc.sendText(g.mid,"OI !")
                       kk.sendText(g.mid,"OI !")  
            ...
            elif msg.text in ["anjir","Anjir","anjing"]:
                cl.sendText(msg.to,"Kucing")
            elif msg.text in ["Kontol","KONTOL","kontol"]:
                cl.sendText(msg.to,"Sans dong !")
            elif msg.text in ["gym","oi","gim","Agym","agym","@alkhoarizmy"]:
                cl.sendText(msg.to,"Wut??")
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"tuh mastah")
            
             #-------------Fungsi Spam Start---------------------#
            elif msg.text in ["Up","up","Up Chat","Up chat","up chat","Upchat","upchat"]:
               if msg.from_ in admin:
                cl.sendText(msg.to,"UP")
                ki.sendText(msg.to,"UP")
                kk.sendText(msg.to,"UP")
                cl.sendText(msg.to,"UP")
                ki.sendText(msg.to,"UP")
                kk.sendText(msg.to,"UP")
                cl.sendText(msg.to,"UP")
